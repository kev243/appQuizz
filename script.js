...
const radioIntputs=document.querySelectorAll("input[type='radio']")
radioIntputs.forEach(radioIntput=> radioIntput.addEventListener('input',
resetColor))

function resetColor(e){
     
    const index=e.target.getAttribute("name").slice(1)-1;
    //pour recuperer le block de question la ou je clique
